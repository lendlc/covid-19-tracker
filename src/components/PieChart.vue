                ...
                axios.all([
                    ...
                    new Chart(document.getElementById("pie-chart"), {
                        ...
                        datasets: [
                            ...
                            data: [
                                this.LocalData.todayCases == 0 ? 1 : this.LocalData.todayCases, 
                                this.LocalData.todayDeaths == 0 ? 1 : this.LocalData.todayDeaths, 
                        ...
                        title: {
                            display: true,
                            text: 'COVID-19 Updates as of ' + new Date(this.date).toLocaleString()
                        }
                        }
                    });
                })  
